                ...
                <div class="col-lg-10">
                    <div class="banner_text text-center">
                        <div class="banner_text_iner">
                            <h1> SaintHappy Tours and Travel</h1>
                    ...
                    <div class="single_place">
                        ...
                        <div class="hover_Text d-flex align-items-end justify-content-between">
                            <div class="hover_text_iner">
                                ...
                                <h3>SaintHappy Tours and Travel Iceland</h3>
                            ...
                            <div class="row justify-content-end">
                                <div class="col-lg-6 col-md-6">
                                    <div class="event_slider_content">
                                        ...
                                        <p>Organizer: <span> Happy Tours and Travel Agency</span> </p>
                                        <div class="rating">
                                            <span>Rating:</span>
                                            <div class="place_review">
                                                <a href="#"><i class="fas fa-star"></i></a>
                ...
                <div class="col-sm-6 col-md-5">
                    <div class="single-footer-widget">
                        ...
                        <ul>
                            ...
                            <li><a href="#">SaintHappy Tours and Travel, Bangladesh</a></li>
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="single-footer-widget footer_icon">
                        ...
                        <p>4156, New garden, New York, USA
                                +880 362 352 783</p>
                        <span>contact@Happy Tours and Travel.com</span>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="ti-heart" aria-hidden="true"></i> by SR Digital
